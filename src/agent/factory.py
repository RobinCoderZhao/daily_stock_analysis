...
def get_tool_registry():
    ...
    from src.agent.tools.structure_tools import ALL_STRUCTURE_TOOLS

    registry = ToolRegistry()
    all_tools = ALL_DATA_TOOLS + ALL_ANALYSIS_TOOLS + ALL_SEARCH_TOOLS + ALL_MARKET_TOOLS + ALL_STRUCTURE_TOOLS
